...
alias rb='~/.config/waybar/restart_bar'
alias signout='hyprctl dispatch exit'
alias push="bash ~/Documents/bash-scripts/git/push.sh"
alias key="cat ~/Documents/key"
alias selectWallpaper="bash ~/.config/hypr/scripts/selectWallpaper.sh"
alias restartWaybar="bash ~/.config/hypr/scripts/restartWaybar.sh"
# vim:ft=zsh
